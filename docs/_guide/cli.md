...
> **Note:** The `--style` flag (`class` / `function`) is deprecated and maps to `class-json` / `function-json`. It is still present in 0.9.1 and will be removed in a future release. Use `--template` instead.
...
Source:    order.json
Template:  pythonic-builder
Generator: xstate-statemachine 0.9.1
