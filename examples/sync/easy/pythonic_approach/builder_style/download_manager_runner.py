# examples/sync/easy/pythonic_approach/builder_style/download_manager_runner.py
# -----------------------------------------------------------------------------
# ⬇️ Download Manager — builder-style Pythonic API
# -----------------------------------------------------------------------------
# Demonstrates `MachineBuilder`: a fluent chain that builds the machine at
# RUNTIME, which is the style to reach for when the shape of the machine is
# decided by configuration rather than written out in advance.
#
...
#         --template pythonic-builder --async-mode no
#
